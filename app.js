...
var _n1k0$kinto_elm_experiments$Model$updateRecord = F2(
		...
		if (_p0.ctor === 'Nothing') {
			...
			return _elm_lang$core$Maybe$Just(
				_elm_lang$core$Native_Utils.update(
					_p0._0,
					{
						title: _elm_lang$core$Maybe$Just(formData.title),
						description: _elm_lang$core$Maybe$Just(formData.description)
					}));
		}
	});
var _n1k0$kinto_elm_experiments$Model$updateRecordInList = F2(
	function (formData, records) {
		...
		if (_p1.ctor === 'Nothing') {
			...
			return A3(
				_elm_lang$core$Dict$update,
				_p1._0,
				_n1k0$kinto_elm_experiments$Model$updateRecord(formData),
				records);
		}
	});
var _n1k0$kinto_elm_experiments$Model$removeRecordFromList = F2(
	function (_p2, records) {
		var _p3 = _p2;
		return A2(_elm_lang$core$Dict$remove, _p3.id, records);
	});
var _n1k0$kinto_elm_experiments$Model$encodeFormData = function (_p4) {
	var _p5 = _p4;
				...
				_1: _elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'title',
							_1: _elm_lang$core$Json_Encode$string(_p5.title)
						},
							{
							ctor: '_Tuple2',
							_0: 'description',
							_1: _elm_lang$core$Json_Encode$string(_p5.description)
						}
						]))
			}
			]));
};
var _n1k0$kinto_elm_experiments$Model$recordToFormData = function (_p6) {
	var _p7 = _p6;
	return A3(
...
var _n1k0$kinto_elm_experiments$Model$initialModel = {error: _elm_lang$core$Maybe$Nothing, records: _elm_lang$core$Dict$empty, formData: _n1k0$kinto_elm_experiments$Form$init, currentTime: 0};
var _n1k0$kinto_elm_experiments$Model$Record = F4(
	function (a, b, c, d) {
		return {id: a, title: b, description: c, last_modified: d};
	});
var _n1k0$kinto_elm_experiments$Model$decodeRecord = A5(
	_elm_lang$core$Json_Decode$object4,
	_n1k0$kinto_elm_experiments$Model$Record,
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'last_modified', _elm_lang$core$Json_Decode$int));
var _n1k0$kinto_elm_experiments$Model$decodeRecords = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data']),
...
var _n1k0$kinto_elm_experiments$Model$DeleteRecordSucceed = function (a) {
	return {ctor: 'DeleteRecordSucceed', _0: a};
};
...
var _n1k0$kinto_elm_experiments$Model$CreateRecordSucceed = function (a) {
	return {ctor: 'CreateRecordSucceed', _0: a};
};
...
var _n1k0$kinto_elm_experiments$Model$sendFormData = function (formData) {
	...
	var _p8 = function () {
		var _p9 = formData.id;
		if (_p9.ctor === 'Nothing') {
			return {ctor: '_Tuple4', _0: _lukewestby$elm_http_builder$HttpBuilder$post, _1: rootUrl, _2: _n1k0$kinto_elm_experiments$Model$HttpFail, _3: _n1k0$kinto_elm_experiments$Model$CreateRecordSucceed};
		} else {
			return {
				ctor: '_Tuple4',
	...
	var method = _p8._0;
	var url = _p8._1;
	var failureMsg = _p8._2;
	var successMsg = _p8._3;
	var request = A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(
			A2(
		...
		A2(
			...
			_n1k0$kinto_elm_experiments$Model$encodeFormData(formData),
			A3(
				_lukewestby$elm_http_builder$HttpBuilder$withHeader,
				'Authorization',
				'Basic dGVzdDp0ZXN0',
...
var _n1k0$kinto_elm_experiments$Model$deleteRecord = function (recordId) {
	var delete_url = A2(_elm_lang$core$Basics_ops['++'], 'https://kinto.dev.mozaws.net/v1/buckets/default/collections/test-items/records/', recordId);
	var request = A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(
			A2(
		...
		A3(
			...
			A3(
				...
				'Content-Type',
				'application/json',
				_lukewestby$elm_http_builder$HttpBuilder$delete(delete_url))));
	return A3(_elm_lang$core$Task$perform, _n1k0$kinto_elm_experiments$Model$HttpFail, _n1k0$kinto_elm_experiments$Model$DeleteRecordSucceed, request);
};
var _n1k0$kinto_elm_experiments$Model$update = F2(
	function (msg, model) {
		...
		switch (_p10.ctor) {
			...
			case 'FetchRecordSucceed':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							formData: _n1k0$kinto_elm_experiments$Model$recordToFormData(_p10._0.data),
			...
			case 'FetchRecordsSucceed':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							records: _elm_lang$core$Dict$fromList(
								A2(
									_elm_lang$core$List$map,
									function (r) {
										return {ctor: '_Tuple2', _0: r.id, _1: r};
									},
									_p10._0.data)),
							error: _elm_lang$core$Maybe$Nothing
						}),
			...
			case 'FormMsg':
				var _p11 = A2(_n1k0$kinto_elm_experiments$Form$update, _p10._0, model.formData);
				var updated = _p11._0;
				var formMsg = _p11._1;
				var _p12 = formMsg;
				if (_p12.ctor === 'Nothing') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								formData: updated,
								records: A2(_n1k0$kinto_elm_experiments$Model$updateRecordInList, updated, model.records)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{formData: updated}),
						_1: _n1k0$kinto_elm_experiments$Model$sendFormData(_p12._0._0)
					};
				}
			case 'CreateRecordSucceed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'EditRecord':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _n1k0$kinto_elm_experiments$Model$fetchRecord(_p10._0)
				};
			...
			case 'DeleteRecord':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _n1k0$kinto_elm_experiments$Model$deleteRecord(_p10._0)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							records: A2(_n1k0$kinto_elm_experiments$Model$removeRecordFromList, _p10._0.data, model.records),
							error: _elm_lang$core$Maybe$Nothing
						}),
					_1: _n1k0$kinto_elm_experiments$Model$fetchRecords
				};
...
var _n1k0$kinto_elm_experiments$Model$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _n1k0$kinto_elm_experiments$Model$Tick);
};
var _n1k0$kinto_elm_experiments$Model$NoOp = {ctor: 'NoOp'};

var _n1k0$kinto_elm_experiments$Utils$plural = F2(
...
var _n1k0$kinto_elm_experiments$Utils$timeAgo = F2(
	function (time, now) {
		...
		return (_elm_lang$core$Native_Utils.cmp(seconds, 10) < 0) ? 'a few seconds ago' : ((_elm_lang$core$Native_Utils.cmp(seconds, 55) < 0) ? A2(_n1k0$kinto_elm_experiments$Utils$plural, 'second', seconds) : (A3(_n1k0$kinto_elm_experiments$Utils$within, 55, 65, seconds) ? 'about a minute ago' : ((_elm_lang$core$Native_Utils.cmp(minutes, 55) < 0) ? A2(_n1k0$kinto_elm_experiments$Utils$plural, 'minute', minutes) : (A3(_n1k0$kinto_elm_experiments$Utils$within, 55, 65, minutes) ? 'about an hour ago' : ((_elm_lang$core$Native_Utils.cmp(hours, 22) < 0) ? A2(_n1k0$kinto_elm_experiments$Utils$plural, 'hour', hours) : (A3(_n1k0$kinto_elm_experiments$Utils$within, 22, 26, hours) ? 'about a day ago' : (A3(_n1k0$kinto_elm_experiments$Utils$within, 6, 8, days) ? 'about a week ago' : (A3(_n1k0$kinto_elm_experiments$Utils$within, 14, 16, days) ? 'about 2 weeks ago' : (A3(_n1k0$kinto_elm_experiments$Utils$within, 20, 22, days) ? 'about 3 weeks ago' : ((_elm_lang$core$Native_Utils.cmp(days, 27) < 0) ? A2(_n1k0$kinto_elm_experiments$Utils$plural, 'day', days) : (A3(_n1k0$kinto_elm_experiments$Utils$within, 27, 33, days) ? 'about a month ago' : ((_elm_lang$core$Native_Utils.cmp(months, 11) < 0) ? A2(_n1k0$kinto_elm_experiments$Utils$plural, 'month', months) : (A3(_n1k0$kinto_elm_experiments$Utils$within, 11, 13, months) ? 'about a year ago' : A2(_n1k0$kinto_elm_experiments$Utils$plural, 'year', years))))))))))))));
	});

var _n1k0$kinto_elm_experiments$View$sortedRecords = function (records) {
	return _elm_lang$core$List$reverse(
		A2(
...
var _n1k0$kinto_elm_experiments$View$errorNotif = function (error) {
	var _p0 = error;
	if (_p0.ctor === 'Nothing') {
...
var _n1k0$kinto_elm_experiments$View$formatLastModified = F2(
	function (timestamp, currentTime) {
		return A2(
			_n1k0$kinto_elm_experiments$Utils$timeAgo,
			_elm_lang$core$Basics$toFloat(timestamp),
			currentTime);
	});
var _n1k0$kinto_elm_experiments$View$recordRow = F2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							A2(_elm_lang$core$Maybe$withDefault, '[empty]', _p2.title))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							A2(_elm_lang$core$Maybe$withDefault, '[empty]', _p2.description))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							A2(_n1k0$kinto_elm_experiments$View$formatLastModified, _p2.last_modified, currentTime))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							'edit',
							_n1k0$kinto_elm_experiments$Model$EditRecord(_p3)),
							_elm_lang$html$Html$text(' '),
							A2(
							_n1k0$kinto_elm_experiments$View$iconBtn,
							'trash',
							_n1k0$kinto_elm_experiments$Model$DeleteRecord(_p3))
						]))
				]));
	});
var _n1k0$kinto_elm_experiments$View$recordsList = F2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('last_modified')
										])),
									A2(
									_elm_lang$html$Html$th,
									_elm_lang$core$Native_List.fromArray(
					...
					A2(
						_elm_lang$core$List$map,
						_n1k0$kinto_elm_experiments$View$recordRow(currentTime),
						records))
				]));
	});
var _n1k0$kinto_elm_experiments$View$view = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Kinto Elm :-)')
					])),
				_n1k0$kinto_elm_experiments$View$errorNotif(_p5.error),
				A2(
				_n1k0$kinto_elm_experiments$View$recordsList,
				_n1k0$kinto_elm_experiments$View$sortedRecords(_p5.records),
				_p5.currentTime),
				A2(
				_elm_lang$html$Html_App$map,
				_n1k0$kinto_elm_experiments$Model$FormMsg,
				_n1k0$kinto_elm_experiments$Form$view(_p5.formData))
			]));
};

var _n1k0$kinto_elm_experiments$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _n1k0$kinto_elm_experiments$Model$init, view: _n1k0$kinto_elm_experiments$View$view, update: _n1k0$kinto_elm_experiments$Model$update, subscriptions: _n1k0$kinto_elm_experiments$Model$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _n1k0$kinto_elm_experiments$Main$main === 'undefined' ? null : _n1k0$kinto_elm_experiments$Main$main);
