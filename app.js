...
var _n1k0$kinto_elm_experiments$View$formatLatsModified = function (timestamp) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_n1k0$kinto_elm_experiments$View$formatLatsModified(
							_elm_lang$core$Basics$toFloat(_p1.last_modified)))
					]))
			]));
};
